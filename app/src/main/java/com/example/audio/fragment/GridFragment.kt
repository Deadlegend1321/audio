...
import com.example.audio.adapter.GridItemAdapter
...
const val KEY_1 = "GM"
const val KEY_2 = "GRID"
class GridFragment : Fragment(), GridItemAdapter.OnItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        recyclerView = view.findViewById(R.id.gridItems)
        ...
        val adapter = GridItemAdapter(cardTitles,cardImages, this)
